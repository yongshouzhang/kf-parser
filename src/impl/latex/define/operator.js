...
define( function ( require ) {
    ...
    return {
        ...
        "vertical":{
            ...
            type: TYPE.FN,
            sign: false,
            handler: require( "impl/latex/handler/vertical" )
        }, 
         "derivative":{
            name: "derivative",
            type: TYPE.FN,
            sign: false,
            handler: require( "impl/latex/handler/derivative" )
        },
        "placeholder":{
            name:"placeholder",
            type:"",
            sign:false,
            handler:require( "impl/latex/handler/placeholder" )
        },
        "empty":{
            name:"empty",
            type:"",
            sign:false,
            handler:require( "impl/latex/handler/empty" )
        }
